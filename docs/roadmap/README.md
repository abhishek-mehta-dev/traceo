...
- Improve CLI tooling and local debugging workflows.
- Add dashboards and playground experiences.
- Expand examples and onboarding guides.

## Phase 5 — Adoption and community growth
- Publish documentation and examples more broadly.
- Gather feedback from early adopters.
- Refine the roadmap based on real usage.
